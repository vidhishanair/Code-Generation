...
def template_copy():
	input_Node = open("List_node_template.java","r")
	input_Node_write = input_Node.read()
	g = open("ListNode.java","w")
...
def __main__():
	...
	attr_create()
	print_Statements()
	os.system("javac ListNode.java")
	os.system("javac List.java")
	os.system("javac ListMain.java")
	os.system("java ListMain")
